...
module.exports = {
  ...
  cooldown: 5,
  aliases: ["pl"],
  description: "Pon una playlist de youtube",
  async execute(message, args) {
    ...
    if (!permissions.has("CONNECT"))
      return message.reply("No puedo conectarme por falta de permisos");
    ...
    message.channel.send(`${message.author} Comenzando la playlist`, playlistEmbed);
    ...
    if (!serverQueue) {
      ...
      try {
        ...
        await channel.leave();
        return message.channel.send(`No se ha podido conectar al canal: ${error.message}`).catch(console.error);
      }
    }
  }
};
